...
export default async function MemoryPage() {
  ...
  return (
    <>
      <div className="mb-4 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-stone">
            Durable facts {ASSISTANT_NAME} carries into every conversation. Tell {ASSISTANT_NAME} something
            worth keeping and it lands here; forget anything that’s no longer true.
          </p>
        </div>
      ...
      {memories.length === 0 ? (
        <Empty>
          Nothing remembered yet. In chat, tell {ASSISTANT_NAME} a standing fact or preference — e.g. “Always
          keep pitches under 120 words” — and it’ll save it here.
        </Empty>
      ) : (
